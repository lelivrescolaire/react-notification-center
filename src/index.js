...
export default class ReduxnotificationCenter extends Component {
  ...
  render() {
    return (
      <div
        className={cn('react-notification-center', 'light-theme', { hide: !this.props.visible })}>
        <div
          className={cn('r-notifications-icon', { active: this.getUnreadLength() })}
                  ...
                  <div
                    ...
                    dangerouslySetInnerHTML={{
                      __html: this.state.current
                        ? this.state.current[this.mapOptions().message]
                        : null
                    }}></div>
                </Content>
                <Footer>
